...
const getSubCategoryId=async(req,res)=>{
    try {
        const subcategory=await subcategoryService.getSubCategoryId(req.params.subcategoryId);
        if(!subcategory){
...
const deleteSubCategory=async(req,res)=>{
    try {
        ...
        const subcategory=await subcategoryService.getSubCategoryId(subcategoryId);
        if(!subcategory){
...
module.exports={createSubCategory,getSubCategoryList,getSubCategoryId,deleteSubCategory };